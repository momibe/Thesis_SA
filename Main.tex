...
\include{04_Framework}
\include{05_Methodology}
\include{06_Cases}
%\include{06a_Taxonomy}
\include{07_Discussion}
\include{08_Conclusion}
\include{Appendices} 


% This executes the index
\indexprologue{The index is meant to assist the reader to be reminded of key projects and concepts }
\printindex
